...
const INVITE_PERMISSIONS = Permissions.sendMessages
...
export default class Invite extends Command {
    ...
    async main(ctx: Context) {
        ...
        await ctx.send(`<https://discordapp.com/api/oauth2/authorize?client_id=${this.clientID}&permissions=${INVITE_PERMISSIONS}&scope=bot>`);
    }
}
