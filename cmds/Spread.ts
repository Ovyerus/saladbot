...
const badDialogue =
  "Oh yeah? You think you're funny? You blithering, wimpy punk? I'll show you 'funny'. I'll go back in time and fart on your dad's balls. You will be eliminated from the gene pool prior to your pitiful conception. Now THAT is 'funny'.";
...
export default class Spread extends Command {
  ...
  async main(ctx: GuildContext) {
    ...
    await channel.createMessage(
      `${currentCheese.mention} spread the cheese touch to ${newCheese.mention}.`
    );
  }
}
